            ...
            <div>
                ...
                <div class="mt-2">
                    ...
                    <textarea
                        ...
                        class="w-full rounded-xl border border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50 shadow-sm p-3 text-sm text-gray-800 resize-y placeholder-gray-400 transition duration-150 ease-in-out"><?= $post['body'] ?></textarea>
                </div>
            </div>
            <button type="submit"
